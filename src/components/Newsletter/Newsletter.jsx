  ...
  return (
    <section className="bg-gradient-to-r from-purple-600 to-indigo-600 py-16 px-4 text-center">
      ...
      <p className="text-purple-200 text-sm mb-6 max-w-md mx-auto">
        Subscribe and be the first to know about new events and exclusive offers.
      </p>
      {subscribed ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          ...
          />
          <button type="submit" className="px-6 py-3 bg-white text-purple-600 font-semibold rounded-full hover:shadow-lg transition">
            Subscribe
          </button>
        </form>
      )}
